...
public class PortalController {
    ...
    public String search(@RequestParam("searchWords") String searchWords, Map<String, Object> resultMap) {
        ...
        SearchDataResponse searchDataResponse = searchService.searchGoodsList(searchWords,0,10);
        List<Goods> goodsList = searchDataResponse.getGoodsList();
        resultMap.put("goodsList", goodsList);
        resultMap.put("totalNUm", searchDataResponse.getTotalNum());
        resultMap.put("from", searchDataResponse.getFrom());
        return "search";
    }
